  ...
  Hooks2.IndexPage = {
    mounted() {
      ...
      this.el.addEventListener("live_admin:toggle_select", (e) => {
        ...
        this.selected = Array.from(this.el.querySelectorAll("input[data-record-id]:checked"), (e2) => e2.dataset.recordId);
